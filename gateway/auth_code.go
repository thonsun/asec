 ...
 * @Last Modified: thonsun, 2020-05-17 21:45:58
 */
...
func ShowAuthCodeRegisterUI(w http.ResponseWriter, r *http.Request) {
	...
	// Format: otpauth://totp/uid?secret=XBSWY3DPEHPK3PXP&issuer=asec
	totpLink := fmt.Sprintf("otpauth://totp/%s?secret=%s&issuer=asec", uid, totpItem.TOTPKey)
	var png []byte
